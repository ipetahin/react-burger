...
describe('store', () => {
  describe('preloaded state is equal to initial state of the slices', () => {
    it('burgerIngredients', () => {
      expect(preloadedState.burgerIngredients).toEqual(burgerIngredientsInitialState);
    });

    it('burgerConstructor', () => {
      expect(preloadedState.burgerConstructor).toEqual(burgerConstructorInitialState);
    });

    it('ingredientDetails', () => {
      expect(preloadedState.ingredientDetails).toEqual(ingredientDetailsInitialState);
    });
