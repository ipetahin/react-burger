...
export const requestUpdateUser = (data: FormData) =>
  requestWithAccessToken<ServerUserResponse>('auth/user', 'PATCH', data).then((res) => (res.success ? res.user : Promise.reject(res)));
...
export const requestSendOrder = (data: ArrayData) =>
  requestWithAccessToken<ServerOrderResponse>('orders', 'POST', data).then((res) => (res.success ? res.order : Promise.reject(res)));
